...
const cards = [
  ...
  },
  {
    userId: MOCK_USER_ID,
    cardType: "developer",
    cardName: "Flutter Creator",
    fullName: "Eric Seidel",
    title: "Co-creator of Flutter & CEO of Shorebird",
    bio: "Co-created Google's Flutter framework. Now building Shorebird — code push for Flutter apps. Ex-Google, ex-WebKit. Passionate about making developers' lives easier.",
    contactEmail: "eric@shorebird.dev",
    location: "San Francisco, USA",
    profileImage: "https://avatars.githubusercontent.com/u/1043779?v=4",
    techStack: ["Flutter", "Dart", "C++", "WebKit", "Rust"],
    links: [
      { label: "Twitter / X", url: "https://x.com/_eseidel" },
      { label: "Website", url: "https://flutter.dev" },
      { label: "Website", url: "https://handbook.shorebird.dev/company/ceo/" },
    ],
    isPublic: true,
    likesCount: 198,
  },
